...
*/
class NewNewspaperItem extends React.Component {
	constructor(props){
		super(props);
	...
	render() {
		...
		if (this.state.big) {
			...
			return (
			 	<article onClick={this.click.bind(this)} className='article' onMouseEnter={this.mouseEnter.bind(this)} onMouseLeave={this.mouseLeave.bind(this)} >
			 		<h2> 
...
export default NewNewspaperItem;
